...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("thabibi/ipinfo")
    client.subscribe("thabibi/date")
    client.subscribe("thabibi/time")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("thabibi/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("thabibi/date", on_message_from_date)
    client.message_callback_add("thabibi/time", on_message_from_time)
